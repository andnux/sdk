...
import top.andnux.volley.RequestQueue;
import top.andnux.volley.Response.ErrorListener;
import top.andnux.volley.Response.Listener;
import top.andnux.volley.ResponseDelivery;
import top.andnux.volley.VolleyError;
import top.andnux.volley.VolleyManager;
import top.andnux.volley.cache.DoubleBitmapCache;
import top.andnux.volley.cache.MemoryBitmapCache;
...
public class ImageLoader {
    ...
    public ImageLoader(Context context) {
        mRequestQueue = VolleyManager.getRequestQueue();
        mCache = new DoubleBitmapCache(context);
    }
