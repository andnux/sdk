...
public final class EasySnackBar extends BaseTransientBar<EasySnackBar> {
    ...
    public interface OnClickListener {
        ...
        void onClick(EasySnackBar snackBar);
    }
     ...
     * {@link com.google.android.material.floatingactionbutton.FloatingActionButton}.
     *
    ...
    public static EasySnackBar make(@NonNull View view, @NonNull View contentView,
        ...
        final CustomContentLayout content =
                (CustomContentLayout) inflater.inflate(
                        R.layout.snackbar_layout_custom, parent, false);
    ...
    @NonNull
    public static EasySnackBar make(@NonNull View view, @NonNull CharSequence text, int duration, boolean top) {
        ViewGroup parent = findSuitableParent(view);
        if (parent == null) {
            throw new IllegalArgumentException("No suitable parent found from the given view. Please provide a valid view.");
        } else {
            LayoutInflater inflater = LayoutInflater.from(parent.getContext());
            SnackBarContentLayout content = (SnackBarContentLayout) inflater.inflate(R.layout.snackbar_layout_default,
                    parent, false);
            EasySnackBar snackbar = new EasySnackBar(parent, content, content, top);
    ...
    @NonNull
    public EasySnackBar setBackground(@NonNull Drawable drawable) {
    ...
    public EasySnackBar setTextSize(int size) {
        SnackBarContentLayout contentLayout = (SnackBarContentLayout) this.mView.getChildAt(0);
        TextView tv = contentLayout.getMessageView();
        tv.setTextSize(size);
        return this;
     ...
     */
    @NonNull
    public EasySnackBar setAction(@StringRes int resId, OnClickListener listener) {
     ...
     */
    @NonNull
    public EasySnackBar setAction(CharSequence text, final OnClickListener listener) {
...
//                dispatchDismiss(BaseCallback.DISMISS_EVENT_ACTION);
    ...
    @NonNull
    public EasySnackBar setActionTextSize(int size) {
        final SnackBarContentLayout contentLayout = (SnackBarContentLayout) mView.getChildAt(0);
        final TextView tv = contentLayout.getActionView();
        tv.setTextSize(size);
        return this;
