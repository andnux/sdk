...
public class FlowLayout<T> extends ViewGroup  {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mHorizontalSpace = ta.getDimension(R.styleable.FlowLayout_horizontalSpace,0);
        mVerticalSpace = ta.getDimension(R.styleable.FlowLayout_verticalSpace,0);
