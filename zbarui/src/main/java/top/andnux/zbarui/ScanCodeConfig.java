...
public class ScanCodeConfig implements Serializable {
    ...
    public boolean need_crop = false;
    ...
    public static class Builder {
        private ScanCodeConfig watcher;

        public Builder() {
            watcher = new ScanCodeConfig();
        }
